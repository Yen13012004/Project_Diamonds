...
<body>
	...
	<nav class="navbar bg-light navbar-light">
		...
		<div class="navbar-nav w-100">
			<a href="${pageContext.servletContext.contextPath}/admin/product" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
			 
			<a href="${pageContext.servletContext.contextPath}/admin/product" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Product</a>
			...
			<a href="${pageContext.servletContext.contextPath}/admin/users" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Users</a> 
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                            ...
                            <a href="${contextPath}/logout" class="dropdown-item">Log Out</a>
                        </div>
                    </div>
                </div>
            </nav>
