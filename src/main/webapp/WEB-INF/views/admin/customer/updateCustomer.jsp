...
<body>
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/admin/customer/updateCustomer">
			...
			<div class="form-group">
				<label for="name" class="col-md-3 text-md-right col-form-label">Created
					at</label> <input name="createdAt" type="date" class="form-control"
					value="${customer.createdAt}" />${customer.createdAt}
			</div>

			<div class="form-group">
				<label for="name" class="col-md-3 text-md-right col-form-label">Update
					at</label> <input name="updatedAt" type="date" class="form-control"
