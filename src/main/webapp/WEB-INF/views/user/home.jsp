            ...
            <div class="row home-3-slider-row">
                    ...
                    <ul class="slides">
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/n-1.jpg" />
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/n-2.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/n-3.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/n-4.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/b-1.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/b-2.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/b-3.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/b-4.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/r-1.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/r-2.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/r-3.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
                      ...
                      <li>
                        <div class="home-3-slider-box">
                           <img alt="" src="${contextPath }/user/images/slider/r-4.jpg" />
                           <div class="slider_caption">
                              <h5>new collections</h5>
                              <h3>Exquisite Designer Necklace</h3>
                              <a href="product.html">Shop now</a>  
               ...
               <div class="col-sm-4 p0">
                  <div id="slider-thum" class="flexslider  homepage-3slider">
                       <ul class="slides">
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/n-1-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/n-2-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/n-3-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/n-4-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/b-1-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/b-2-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/b-3-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/b-4-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/r-1-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/r-2-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/r-3-big.jpg" />
                         </li>
                         <li>
                           <img alt="" src="${contextPath }/user/images/slider/r-4-big.jpg" />
                         </li>
                       </ul>
                     </div>
                  </div>
            ...
            <div class="row m0">
               <div class="col-sm-3 product">
                  <div class="productInner row m0">
                     <div class="row m0 imgHov">
                        <img src="${contextPath }/user/images/product/1.png" alt="">

                        <div class="row m0 hovArea">
                            <img src="${contextPath }/user/images/product/1a.png" alt="">
                     ...
                     <div class="row m0 proName"><a href="single-product.html">Curabitur cursus dignis</a></div>
