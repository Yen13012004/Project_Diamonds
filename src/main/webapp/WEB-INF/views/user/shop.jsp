                ...
                <div class="col-sm-4 product2">
                    <div class="row m0 thumbnail">
                        <div class="row m0 imgHov">
                            ...
                            <div class="hovArea row m0">
                                <div class="links row m0">
                                    ...
                                    <a class="lightbox" href="${contextPath }/user/images/product/pro2p/1.png" data-lightbox="product1" data-title="Maximus quam posuere"><i class="fas fa-expand"></i></a>
                                </div>
                        ...
                        <div class="row m0 productIntro">
                            <h5 class="heading"><a href="single-product.html">Maximus quam posuere</a> <span><del>$240</del> $180</span></h5>
